...
##`2024-03-27` V9.10.19 [download](https://github.com/Qeedji/archives/blob/master/downloads/tab10/aosp-tab10-setup-9.10.19)
>##### **NOTE**
...
***********************************************************************
#### **USER MANUAL**
- TAB10s Qeedji user manual 9.10.19~001D_en [download](https://github.com/Qeedji/archives/blob/master/downloads/tab10/tab10s-qeedji-user_manual-9.10.19~001D_en.pdf)
- TAB10b Qeedji user manual 9.10.19~001D_en [download](https://github.com/Qeedji/archives/blob/master/downloads/tab10/tab10b-qeedji-user_manual-9.10.19~001D_en.pdf)
#### **DEVELOPER MANUAL**
- TAB10s developer manual 9.10.19~001C_en [Download](https://github.com/Qeedji/archives/blob/master/downloads/tab10/tab10s-developer_manual-AOSP-9.10.19~001C_en.pdf)
- TAB10b developer manual 9.10.19~001C_en [Download](https://github.com/Qeedji/archives/blob/master/downloads/tab10/tab10b-developer_manual-AOSP-9.10.19~001C_en.pdf)
...
##`2023-09-28` V9.10.16 [download](https://github.com/Qeedji/archives/blob/master/downloads/tab10/aosp-tab10-setup-9.10.16.fqs)
>##### **IMPORTANT**
For V9.10.10_betaX version, the *LAN_1* interface had priority over *WLAN_1*. For `AQS` V9.10.10 (or above), the *WLAN_1* interface is now priority. So after having upgraded the device with the `AQS` V9.10.10 (or above version), the device Web user interface or the device WebDAV server may be available with the IP address of the *WLAN_1* interface, instead of the one of the *LAN_1* interface
>##### **BUG FIX, NEW FEATURES, MINOR UPDATES**
