...
User manual SignCom 1.13.10~002A (FR) for INNES Screen Composer 4.12.10 [download](app-signcom/screen-composer-signcom-usermanual-1.13.10~001A_fr.pdf){.auth-downloads}

User manual SignCom 1.13.10~002A (EN) for INNES Screen Composer 4.12.10 [download](app-signcom/screen-composer-signcom-usermanual-1.13.10~001A_en.pdf){.auth-downloads}

User manual SignCom 1.10.11~002D (DE) for INNES Screen Composer 4.10.11 [download](app-signcom/screen-composer-signcom-usermanual-1.10.10~002D_de.pdf){.auth-downloads}
